...
@section('title','Sub-category wise product')
@section('content')
<!-- =========================
    Header Top Section
============================== -->
...
============================== -->
<section id="subcategory-wise-product" class="recent-product-wrapper recent-pro-2">
...
<script type="text/javascript">
    window['loaded_subcategory_product_ids'] = @json($products->active_products->pluck('id')->toArray());
    if (loaded_subcategory_product_ids.length == 0)
