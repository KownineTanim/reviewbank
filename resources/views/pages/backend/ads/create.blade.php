...
<div class="container-fluid">
    <div class="col-xl-10 offset-xl-1 box-margin height-card">
        <div class="card card-body">
            <h4 class="card-title mb-2 text-center">Add advertise</h4>
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    <form action="javascript:void(0)" method="post" id="landing-page-item-form" enctype="multipart/form-data" data-parsley-validate >
                        <div class="form-group col-md-12">
                            <label for="title">Title :</label>
                            <input type="text" class="form-control" name="title" id="title" placeholder="Enter a Title for Ads" required>
                        </div>
                        <div class="form-group">
                            <label>Select Template :</label>
                            <input type="radio" class="form-check-input ml-1 " name="template" id="template-1" value="grid_one">
                            <label for="template-1" class="form-check-label ml-4"><img src="{{ asset('frontend/ads/grid_one.png') }}" width="250" alt=""></label>
                            <input type="radio" class="form-check-input ml-1 " name="template" id="template-2" value="grid_two">
        ...
        $.ajax({
             ...
             success: function (response) {
                 if (response.status == 'success') {
                     ...
                     toastr.success('Advertise added successfully');
                 } else {
