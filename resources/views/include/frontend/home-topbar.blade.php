        ...
        <div class="row">
            ...
            <div class="col-6 col-sm-6 col-md-4  col-lg-3 col-xl-3">
                <div class="language-and-currency-btn">
                    ...
                    <img src="{{ asset('frontend/img/flag-icon.jpg') }}" alt="flag-icon">
                    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                        <div class="btn-group" role="group">
                            ...
                            <div class="dropdown-menu wd-btn-country-list" aria-labelledby="btnGroupDrop3">
                                <a class="dropdown-item" href="#"><img src="{{ asset('frontend/img/flag-icon-2.png') }}" alt="flag-icon"> Bangla</a>
                                <a class="dropdown-item" href="#"><img src="{{ asset('frontend/img/flag-icon-3.png') }}" alt="flag-icon"> Spanish</a>
                            </div>
                        </div>
                    </div>
